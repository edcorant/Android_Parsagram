...
public class Compose_Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        caption = view.findViewById(R.id.Caption_textbox);
        photo_preview = view.findViewById(R.id.photo_box);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (description.isEmpty()) {
                    Toast.makeText(getContext(), "Cannot make post with empty description.", Toast.LENGTH_SHORT).show();
                }

                if (photo_file == null || photo_preview.getDrawable() == null) {
                    Toast.makeText(getContext(), "Cannot make post without photo.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void launch_camera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider", photo_file);
